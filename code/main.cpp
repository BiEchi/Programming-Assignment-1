...
int main() {
  ...
  system(
      "cat ../database/RegistrationEmergency1.csv "
      "../database/RegistrationInBed2.csv ../database/RegistrationVaccine3.csv "
      "> ../output/Registration.csv");
  system(
  ...
  operationRoutine(startTime, blockList, database, blackListRegister,
                   central_Queue, people, withdrawProm, localHospitals,
                   "Emergency1.csv");
  ...
  Reporting_monthly(localHospitals.treated_list, central_Queue,
  ...
  cout << "Please enter the address type (from 1 to 7) to get all people with "
          "the address"
       << endl;
  string queryType;
  cin >> queryType;
  hashMap.findAll(queryType, bPlusTree);
  system("echo '\33[32mSuccessfully utilized the Hash Table.\33[0m' ");

  cout << "Utilizing the B Tree to perform a display of all names in the "
          "database, in the order of first key in the B Tree (name)..."
       << endl;
  sleep(2);
  ...
  system("echo '\33[32mSuccessfully utilized the B Tree.\33[0m' ");
  sleep(1);
  ...
  system(
      ...
      "starting... ### \33[0m' ");
  sleep(1);
  query(hashMap, bPlusTree);
  sleep(1);
  system(
      "echo '\33[32mSuccessfully generated the query about "
      "thresholds.\33[0m' ");
