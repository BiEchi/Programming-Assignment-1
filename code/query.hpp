...
void query(HashMap addressIndex) {
    ...
    cout << "Third threshold." << endl;
    
    cout << "The percentage of patients of emergency cure is "
    << treatmentType1 / (treatmentType1 + treatmentType2 + treatmentType3)
    << endl;
    cout << "The percentage of patients in hospital bed is "
    << treatmentType2 / (treatmentType1 + treatmentType2 + treatmentType3)
    << endl;
    cout << "The percentage of patients under vaccination is "
    << treatmentType3 / (treatmentType1 + treatmentType2 + treatmentType3)
    << endl;
    
    /* Node within Threshold 2 */
