...
int main()
{
    // getReportingWeeklyType(int &personType, int &sortType);
    forwardToCentralQueue(PeopleLocalQueue &people, FibonacciPQ &centralQueue);
    appointmentQueuesInit(queueManger *localHospital);
    assignToLocalHospital(queueManger *localHospital, FibonacciPQ *centralQueue);
